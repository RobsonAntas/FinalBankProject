...
public class RecyclerAdapterF3 extends RecyclerView.Adapter<RecyclerAdapterF3.ViewHolder>{
    private Context context;
    private List<String> menuOptions;
    private LayoutInflater layoutInflater;

    public RecyclerAdapterF3(Context context, List<String> menuOptions) {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent oIntent = new Intent(context, ActionsActivity.class);
