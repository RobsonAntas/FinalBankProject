package com.rantas.bankfinalproject.activities.adapters;
...
import com.rantas.bankfinalproject.activities.ExtratoActivity;
import com.rantas.bankfinalproject.activities.PagamentoActivity;
                ...
                public void onClick(View view) {
                    ...
                    switch (menuOptions.indexOf(menuOptions.get(getLayoutPosition()))){
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            Intent pIntent = new Intent(context, ExtratoActivity.class);
                            pIntent.putExtra("extrato",menuOptions.get(getLayoutPosition()));
